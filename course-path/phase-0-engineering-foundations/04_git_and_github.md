...
### 9.2 — Merge Commit vs. Fast-Forward vs. Rebase
...
#### 🎨 Git History Integration Strategies
...
git rebase main # Perform ONLY on local feature branches before PR merge
```
...
#### 🎨 Commit Hash Dependency Cascade
...
### 9.4 — `git log -S <string>` (Pickaxe Search)
...
#### 🎨 Searching Active Files vs. Searching Git History
...
git log --all -S "sk-proj-98427598247" -p
```
...
### 9.7 — `git revert` vs. `git reset --hard`
...
#### 🎨 Destructive Reset vs. Safe Revert
