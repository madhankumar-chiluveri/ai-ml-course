# 📱 Social Media Content Tracker & Publication Pipeline

Central tracking ledger for technical content packs generated across LinkedIn and Instagram, built on the **Claude / Anthropic Warm Editorial Aesthetic**.
...
## 🎨 Theme Standards & Editorial Guidelines

All visual assets and carousel slides adhere to the **Claude Warm Editorial Theme**:
- **Background Canvas:** Warm Ivory Cream (`#FBF9F5` / `#FAF7F2`)
- **Card Containers:** Soft Parchment White (`#FFFFFF` with `#EFEBE4` border)
- **Primary Accent:** Anthropic Terracotta Coral (`#DA7756` / `#CC5439`)
- **Secondary Accent:** Muted Amber Sand (`#D97706` / `#E5A93C`)
- **Primary Text:** Deep Charcoal Black (`#1A1A1A` / `#2C2825`)
- **Secondary Text:** Warm Slate Taupe (`#55514D` / `#4A4643`)
- **Typography:** Instrument Serif / Playfair (Headlines) + Inter / DM Sans (Body) + Fira Code (Code)
